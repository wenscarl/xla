...
struct FusedMHAF8Op {
  ...
  RunnerFromAlgorithmDesc(const AlgorithmDesc& desc, Config config,
    ...
    return dnn->FusedMHAF8RunnerFromDesc(
        ...
        // config.descale_q_descriptor, config.descale_k_descriptor,
        // config.descale_v_descriptor, config.descale_s_descriptor,
        //  config.scale_s_descriptor, config.scale_o_descriptor,
        //  config.amax_s_descriptor, config.amax_o_descriptor,
